...
namespace R5T.Bristol.Lib.Identification
{
    public static class Constants
    {
        ...
        /// <summary>
        /// Must starti with 3 upper-case letters, an upper-case letter, 6 numbers, and end with a number (11 characters).
        /// </summary>
        public const string CheckedContainerIdentificationRegexPattern = @"^[A-Z]{3}[A-Z][0-9]{6}[0-9]$";
        /// <summary>
        /// Must start with 3 upper-case letters, an upper-case letter, and end with 6 numbers (10 characters), without the final check digit.
        /// </summary>
        public const string ContainerIdentificationRegexPattern = @"^[A-Z]{3}[A-Z][0-9]{6}$";

        public const string InvalidContainerIdentificationValue = "XXXX000000";
        public const string InvalidCheckedContainerIdentificationValue = "XXXX0000001";
    }
}
